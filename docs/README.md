...
- `decisions/NEC-177/adr-007-unified-agent-invocation.md`：统一 Codex Coder harness 与 DeepSeek/普通 LLM Provider 的 Agent 调用接口，并划分 durable Run 与 direct invocation。
