...
use crate::protocol::checkout::{CheckoutError, CheckoutErrorCode};
use crate::protocol::forge as protocol;
use crate::rpc::ErrorCode;
use crate::service::forge::{self as port, Forge};
...
fn check_details(
    ...
    let result = forge.check_details(
        ...
        crate::ports::forge::CheckDetailsQuery {
            repo_owner: request.repo_owner.as_deref(),
            repo_name: request.repo_name.as_deref(),
