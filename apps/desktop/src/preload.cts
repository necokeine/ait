...
const api: AitDesktopApi = {
  ...
  projectSessions: (projectId, status) => invoke("project.sessions", { projectId, status }),
  codexThreads: (input) => invoke("project.codex-threads", input),
  syncCodexThread: (input) => invoke("project.sync-codex-thread", input),
  ...
  bindProjectAgent: (input) => invoke("project.bind-agent", input),
  closeProject: (projectId) => invoke("project.close", { projectId }),
  ...
  setSessionArchived: (input) => invoke("session.set-archived", input),
